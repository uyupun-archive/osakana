...
class CreateReadingListCollectionMigrator(BaseMigrator):
    def __init__(
        self, reading_list_record: Type[ReadingListRecord] = ReadingListRecord
    ) -> None:
        super().__init__()
    ...
    def up(self) -> None:
        ...
        self._db_client.sortable(
            index_name=self._index_name, attributes=[created_at, updated_at]
        )
        ...
        self._db_client.filterable(
            index_name=self._index_name, attributes=[is_bookmarked, is_read]
        )
